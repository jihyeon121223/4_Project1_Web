          ...
          a(i).on("mouseleave", t, function (t) {
            ...
            if (!i.find(":hover").length) {
              var r = void 0 == t.offsetX ? t.pageX - a(this).offset().left : t.offsetX,
                ...
                d = "";
              (d = f < 0.1 * t.data.height() ? "down" : f > 0.9 * t.data.height() ? "up" : r < 0.1 * t.data.width() ? "left" : "right"),
    ...
    init: function (e, s) {
      ...
      for (var n = 0; n < d.length; n++) {
        ...
        if (("static" == o.css("position") && o.css("position", "relative"), u)) {
          0 == o.find("img").length
            ? o.append('<img class="imgfix_src_img" src="' + o.data("fix-img") + '" />')
          ...
          a("#imgfix_cover_transitions_for_" + _).remove(),
            "none" != m.data("slide") || "none" != m.data("fade") || "none" != m.data("scale")
              ? (a("head").append(
                ...
                f(m, _))
              : a("head").append(
                  '<style id="imgfix_cover_transitions_for_' + _ + '">#' + _ + " .imgfix_cover_wrapper{position: absolute; z-index: 1;}</style>"
                );
        }
      }
    },
