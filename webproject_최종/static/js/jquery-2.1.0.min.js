    ...
    (o.extend = o.fn.extend =
      function () {
        var a,
          ...
          j = !1;
        for (
          "boolean" == typeof g && ((j = g), (g = arguments[h] || {}), h++), "object" == typeof g || o.isFunction(g) || (g = {}), h === i && ((g = this), h--);
          i > h;
          h++
        )
        ...
        while (j--)
          (h = Y.exec(b[j]) || []),
            ...
            n &&
              ...
              (m = i[n]) ||
                ((m = i[n] = []), (m.delegateCount = 0), (l.setup && l.setup.call(a, d, p, g) !== !1) || (a.addEventListener && a.addEventListener(n, g, !1))),
  ...
  o.extend({
    ...
    ajax: function (a, b) {
      ...
      (i = k.global),
        ...
        k.ifModified &&
          (o.lastModified[d] && v.setRequestHeader("If-Modified-Since", o.lastModified[d]), o.etag[d] && v.setRequestHeader("If-None-Match", o.etag[d])),
